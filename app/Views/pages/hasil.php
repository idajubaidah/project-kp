					...
					<div class="col form-content" >
						...
						<div class="form-row">
							<div class="form-holder">
								<input type="text" placeholder="NIK" class="form-control" readonly id="nik"  value="<?= $dataHasil['nik']; ?>" name="nik" minlength="16" maxlength="16" required >
							</div>
							<div class="form-holder">
								<input type="text" placeholder="Nama Lengkap" class="form-control" readonly value="<?= $dataHasil['nama']; ?>" name="nama" required>
							</div>
						</div>
						<div class="form-row">
							<div class="form-holder">
								<input placeholder="Tanggal Lahir" class="form-control" readonly value="<?= $dataHasil['tgl_lahir']; ?>" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="tgl_lahir" name="tgl_lahir" required />
							</div>
							<div class="form-holder">
								<input type="text" placeholder="No. Handphone" class="form-control" readonly value="<?= $dataHasil['no_hp']; ?>" name="no_hp" minlength="11" maxlength="13" required>
							</div>
						</div>
						<div class="form-row">
							<div class="form-holder">
								<input type="text" placeholder="Alamat" class="form-control" readonly value="<?= $dataHasil['alamat']; ?>" name="alamat" required>
							</div>
							
							<div class="form-holder">
								<input type="text" placeholder="Jenis Kelamin" class="form-control" readonly value="<?= $dataHasil['jenis_kelamin']; ?>" name="jenis_kelamin" required>
							</div>
						...
						<div class="form-row">
							<div class="form-holder" >
								...
								foreach ($query->getResult() as $row) { ?>
									<select readonly  class=" form-control" name="satuan_kerja" id="satuan_kerja" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= $row->satuan_kerja ?>" required>
										<option value="<?= $dataHasil['kd_satuan_kerja']; ?>"><?= $row->satuan_kerja ?></option>
									</select>
								<?php } ?>
							</div>
							...
							<div class="form-holder">
								<?php
								foreach ($queryy->getResult() as $row) { ?>
									<select readonly class=" form-control" name="unit_kerja" id="unit_kerja" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= $row->unit_kerja ?>" required>
										<option selected value="<?= $dataHasil['kd_unit_kerja']; ?>" ><?= $row->unit_kerja ?></option>
									</select>
								<?php } ?>
							</div>
